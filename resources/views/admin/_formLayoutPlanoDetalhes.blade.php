<div class="row">
    ...
    <div class="form-group col-md-2">
        ...
        <input type="text" readonly="true" class="form-control" name="cir"
...
<div class="row">
    <div class="form-group col-md-3">
        ...
        <input type="text" readonly="true" class="form-control" name="velocmaxdown"
    ...
    <div class="form-group col-md-3">
        ...
        <input type="text" readonly="true" class="form-control" name="velocmaxup"
    ...
    <div class="form-group col-md-3">
        ...
        <input type="text" readonly="true" class="form-control" name="velocmindown"
    ...
    <div class="form-group col-md-3">
        ...
        <input type="text" readonly="true" class="form-control" name="velocminup"
...
<div class="row">
    <div class="form-group col-md-3">
        ...
        <input type="text" readonly="true" class="form-control" name="equipamento"
    ...
    <div class="form-group col-md-3 ">
        ...
        <input type="text" readonly="true" class="form-control" name="valordecusto"
    ...
    <div class="form-group col-md-3 ">
        ...
        <input type="text" readonly="true" class="form-control" name="valormensal"
