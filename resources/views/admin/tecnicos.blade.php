...
- xs (extra-small devices) - <576px - sm (small devices) - 576px <=vwp <=767px - md (medium devices) - 768px <=vwp
    ...
    <body>
        ...
        <div class="container">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-outline-warning"
                                        href="{{ route('admin.tecnicos.editar', $registro->id) }}">Editar</a>
                                    <a class="btn btn-outline-danger"
                                        href="{{ route('admin.tecnicos.deletar', $registro->id) }}">Deletar</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
            ...
            <div class="row">
                <a class="btn btn-outline-success" href="{{ route('admin.tecnicos.adicionar') }}">Adicionar</a>
            </div>
    </div>
