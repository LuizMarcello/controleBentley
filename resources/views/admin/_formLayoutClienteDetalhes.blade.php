...
{{-- <form action="add.php" method="post"> --}}
    ...
    <div class="row">
        ...
        <div class="form-group col-md-2">
            ...
            <input type="text" readonly="true" class="form-control" name="ie" value="{{ isset($registro->ie) ? $registro->ie : '' }}">
        </div>
        ...
        <div class="form-group col-md-2">
            ...
            <input type="text" readonly="true" class="form-control" name="ufie" value="{{ isset($registro->ufie) ? $registro->ufie : '' }}">
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-3">
            ...
            <div class="modal fade" id="migClienteModal" tabindex="-1" role="dialog"
                aria-labelledby="migClienteModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
