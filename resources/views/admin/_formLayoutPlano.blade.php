...
<div class="row">
    ...
    <div class="form-group custom-selectd">
        ...
        <select class="form-control" name="situacao" id="alterar4">
            ...
            <?php echo selected4('Cancelado', $registro->situacao); ?>>
                Cancelado
            </option>

            <option value="Desinstalado"
            <?php echo selected4('Desinstalado', $registro->situacao); ?>>
                Desinstalado
            </option>

            <option value="Desligado por falta de pagamento"
            <?php echo selected4('Desligado por falta de pagamento', $registro->situacao); ?>>
                Desligado por falta de pagamento
            </option>

            <option value="Em cadastramento"
            <?php echo selected4('Em cadastramento', $registro->situacao); ?>>
                Em cadastramento
            </option>

            <option value="Em cancelamento"
            <?php echo selected4('Em cancelamento', $registro->situacao); ?>>
                Em cancelamento
            </option>

            <option value="Em manutenção"
            <?php echo selected4('Em manutenção', $registro->situacao); ?>>
                Em manutenção
            </option>

            <option value="Em revisão"
            <?php echo selected4('Em revisão', $registro->situacao); ?>>
                Em revisão
            </option>

            <option value="Equipamentos designados"
            <?php echo selected4('Equipamentos designados', $registro->situacao); ?>>
                Equipamentos designados
            </option>

            <option value="Instalação agendada"
            <?php echo selected4('Instalação agendada', $registro->situacao); ?>>
                Instalação agendada
            </option>

            <option value="Instalação realizada"
            <?php echo selected4('Instalação realizada', $registro->situacao); ?>>
                Instalação realizada
            </option>

            <option value="Não aprovado serasa"
            <?php echo selected4('Não aprovado serasa', $registro->situacao); ?>>
                Não aprovado serasa
            </option>

            <option value="Ponto em operação"
            <?php echo selected4('Ponto em operação', $registro->situacao); ?>>
                Ponto em operaçãoa
            </option>

            <option value="Selecionado para desinstalação"
            <?php echo selected4('Selecionado para desinstalação', $registro->situacao); ?>>
                Selecionado para desinstalação
            </option>

            <option value="Selecionado para desligamento"
            <?php echo selected4('Selecionado para desligamento', $registro->situacao); ?>>
                Selecionado para desligamento
            </option>

            <option value="Selecionado para religamento"
            <?php echo selected4('Selecionado para religamento', $registro->situacao); ?>>
                Selecionado para religamento
            </option>

            <option value="Suspensão administrativa"
            <?php echo selected4('Suspensão administrativa', $registro->situacao); ?>>
                Suspensão administrativa
            </option>

            <option value="Suspensão temporária"
            <?php echo selected4('Suspensão temporária', $registro->situacao); ?>>
